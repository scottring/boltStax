...
export const AddSupplierModal = ({ isOpen, onClose, onSupplierAdded }: AddSupplierModalProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Validate all fields except 'id' since it will be generated by Firestore
      const { id: _, ...validationSchema } = SupplierSchema.shape;
      const validationResult = z.object(validationSchema).safeParse(newSupplier);
      ...
      const createdSupplier = await addSupplier(newSupplier);
